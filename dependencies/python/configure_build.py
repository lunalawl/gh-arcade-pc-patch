...
def main():
	...
	game_name = "gh3"
	data_folder_name = "arcade"
	pak_file_name = "arcade"
	...
	platform_dir = os.path.abspath(os.path.join("platform"))
	out_dir = os.path.abspath(os.path.join("out"))

	# account for platform folder differences
	match args.platform:
		case "gh3ml":
			pak_file_dir = os.path.join(out_dir, "gh3ml", "Mods", "GHArcadePC", "pak")
		case "ps2":
